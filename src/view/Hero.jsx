    ...
    <>
      <Section id="hero">
        <div className="flexCenter flex-cols flex-rows gap-12 mb-32">
          <div className="relative max-w-7xl mx-auto h-[450px] md:h-[750px] lg:h-[924px] w-full flexCenter">
            ...
            <img
              src="/img/hero.png"
              alt=""
              className="w-full h-[450px] md:h-[900px] lg:h-[1124px]  absolute -bottom-3 left-1/2 -translate-x-1/2 z-1"
            />
          </div>
        </div>
        <SlidingText />
